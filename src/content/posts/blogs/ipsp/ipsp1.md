...
1. Complete 10th grade - Choose the Science stream with Physics and Math as subjects.
...
2. Graduate your 12th grade (SSC, CBSE, ISCE) with 50%+ (Physics and Math must be included).
    - If you are from IB, I am unfortunately unaware if you get any benefits (I think you would).

3. Now you have the same three routes as I mentioned in Q1 (Choose one of them),
   1. Studienkolleg
   2. Finish one year of [B.Sc](http://b.sc/) or B. Tech at a University recognised by Germany (Check Anabin)
   3. JEE Advanced: Since 2016, passing the JEE-Advanced exam makes you directly eligible to apply without studying for one extra year at a University. I know that JEE-Advanced does not have "passing", but instead, they have "cut-off".
