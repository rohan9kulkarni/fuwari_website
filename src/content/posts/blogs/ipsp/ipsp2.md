...
In my opinion, this is mainly due to three reasons (two of them strongly connected) :
...
2. (Connected to 1) The program is highly accelerated regarding the syllabus. You learn and apply concepts in your semester I/II generally taught in top graduate-level schools in USA/Canada (Even MIT). These same concepts are usually taught in semester III/IV if you were in a typical [B.Sc](http://B.Sc). Physics in Germany (Non-IPSP) making [B.Sc](http://B.Sc). Physics already quite accelerated here.
